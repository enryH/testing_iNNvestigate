...
try:
    from keras.constraints import NonPos
except ImportError:
    print("""
    # add to keras/constraints.py
    # see: https://github.com/enryH/keras/commit/90e7af4a0abdf45f80a13b538bc757c5ec805340
    # Where does the file lie?
    # display environments: conda info -e
    # Identify your environment, named env-name, e.g. charite.
    # Go to constraints.py
    # Unix: /env-name/lib/python3.6/site-packages/keras/constraints.py
    # Win:  env-name\Lib\site-packages\keras\constraints.py
...
model = keras.models.Sequential([
    ...
    keras.layers.Conv2D(64, (3, 3), activation="relu", bias_constraint=NonPos()),
    keras.layers.MaxPooling2D((2, 2)),
    keras.layers.Flatten(),
    keras.layers.Dense(512, activation="relu", bias_constraint=NonPos()),
